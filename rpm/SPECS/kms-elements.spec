...
Patch1: https://patch-diff.githubusercontent.com/raw/Kurento/kms-elements/pull/28.diff#/kms-elements-PR28.diff
...
%prep
%setup -c -n %{package_dir} -T -D
#patch1 -p1 # used bbb-kms-elements.patch instead
